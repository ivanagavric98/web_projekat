		    ...
		    <div class="row d-flex justify-content-center align-items-center h-100">
		      <div class="col-lg-8 col-xl-6">
		        <div class="card rounded-3">
		          <img src="https://media.istockphoto.com/vectors/food-delivery-logo-with-bike-man-or-courier-vector-id1269250886" class="w-100" style="border-top-left-radius: .3rem; border-top-right-radius: .3rem;" alt="Sample photo">
		          <div class="card-body p-4 p-md-3">
		            <h3 class="mb-4 pb-2 pb-md-0 mb-md-5 px-md-2">Edit Personal Info</h3>
